...
export function ProductCardSkeleton() {
  return (
    <div className="flex flex-col h-full  rounded-2xl border border-[var(--fordza-cream-dark)] bg-[var(--fordza-cream)] overflow-hidden relative">
      ...
      {/* Gambar area */}
      <div className="relative w-full bg-white  overflow-hidden z-10 shadow-sm" style={{ aspectRatio: "1 / 1" }}>
        <Skeleton className="w-full h-full bg-gray-100" />
      </div>

      {/* Body */}
      <div className="flex flex-1 flex-col gap-2 p-2.5 pb-3 pt-5 z-10">
        ...
        {/* Footer */}
        <div className="mt-auto flex items-end justify-between  pb-3 pt-3">
